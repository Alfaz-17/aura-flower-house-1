                ...
                <div className="flex flex-col gap-3">
                  <a
                    ...
                    href={`https://wa.me/919737828614?text=${encodeURIComponent(
                      `Hello,\n\nI am interested in ordering/inquiring about the "${item.title}" (${item.category}).\n\nDimensions: ${item.dimensions || 'N/A'}\n\nPlease share price and availability.`
                    )}`}
                    className="w-full inline-flex items-center justify-center gap-3 px-8 py-4 bg-[#25D366] text-white text-[11px] uppercase tracking-[0.3em] font-bold hover:bg-[#25D366]/90 transition-all"
                  >
                  ...
                  <a href={`mailto:info@aurahouseofflowers.com?subject=Inquiry: ${item.title}`} className="w-full inline-flex items-center justify-center gap-2 px-8 py-3 border border-foreground/20 text-[10px] uppercase tracking-[0.2em] font-medium hover:bg-foreground hover:text-background transition-all">
                    Inquire via Email
                  </a>
                </div>
              </div>
