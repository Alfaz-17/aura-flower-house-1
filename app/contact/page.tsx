...
export default function ContactPage() {
  return (
    <main className="min-h-screen bg-background">
      {/* Hero Section - Reduced Padding for Visibility */}
      <section className="pt-24 md:pt-32 pb-12 px-6 md:px-12 bg-background">
        <div className="max-w-screen-2xl mx-auto">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <span className="text-[11px] uppercase tracking-[0.4em] text-primary font-bold">Contact Us</span>
            <h1 className="font-serif text-4xl md:text-6xl leading-none text-primary">
            ...
            <p className="text-base text-muted-foreground font-light leading-relaxed max-w-xl mx-auto">
              Ready to start your project? Fill out the form below or visit our studio.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-24 px-6 md:px-12 bg-background">
        <div className="max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          {/* Contact Form - Placed First for Mobile Priority, Second on Desktop */}
          ...
          {/* Contact Information - Placed Second on Mobile, First on Desktop */}
